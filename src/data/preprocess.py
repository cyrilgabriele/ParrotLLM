...
def run_preprocess(args: PreprocessConfig, seed: int) -> None:
    ...
    actual_tokenizer_name = args.tokenizer_name if args.tokenizer_name else DEFAULT_TOKENIZER_NAME
    print(
        f"[data] Tokenizer: {actual_tokenizer_name}"
    ...
    if not topic_classes or skip_topic_filter:
        ...
        print(f"  Model: {args.topic_model_name}")
